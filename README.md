...
Only use `implementation` if you want to package another Java library *with your mod*, and that library is not present in Mindustry already. If you do, check that its license is compatible with GPLv3 and list it under [Third-Party Notices](#third-party-notices).
